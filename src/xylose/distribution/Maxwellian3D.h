...
/** \file
 * Maxwellian3D distribtuion functor implementation.
 *
 * Copyright 2004-2008 Spencer Olson.
 */

#ifndef xylose_distribution_Maxwellian3D_h
#define xylose_distribution_Maxwellian3D_h
...
namespace xylose {
  namespace distribution {
    ...
    struct Maxwellian3D {
       ...
       */
      Maxwellian3D(const double & b, const double & offs = 0.0)
        : beta(b), v0(offs) { }
...
#endif // xylose_distribution_Maxwellian3D_h
