...
/** \file
 * Maxwellian2D distribtuion functor implementation.
 *
 * Copyright 2004-2008 Spencer Olson.
 */

#ifndef xylose_distribution_Maxwellian2D_h
#define xylose_distribution_Maxwellian2D_h
  ...
  namespace distribution {
    ...
    */
    struct Maxwellian2D {
       ...
       */
      Maxwellian2D(const double & b, const double & offs = 0.0)
        : beta(b), v0(offs) { }
...
#endif // xylose_distribution_Maxwellian2D_h
