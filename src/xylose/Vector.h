...
namespace xylose {
   ...
   */
  #define V3t(type,a,b,c)       xylose::__CONCAT(vect3,type)(VInit,((type)(a)),((type)(b)),((type)(c)))

  #define V3tcast(type,cast_type,a,b,c)   xylose::__CONCAT(vect3,type)((cast_type)0,VInit,((cast_type)(a)),((cast_type)(b)),((cast_type)(c)))
   ...
   */
  #define V3t_(type,a,b,c)       (*(xylose::Vector<type,3>*)((const type[3]){((type)(a)),((type)(b)),((type)(c))}))
   ...
   * N-Vectors.
   */
  #define VNCAST(t,n,a)          (*((xylose::Vector<t,n>*)(a)))
  ...
  #define VInit   ((xylose::VInit_t *)NULL)
